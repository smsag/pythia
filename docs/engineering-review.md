...
**Files:** `sidebar.ts`, new `ui/*Controller.ts` — **In progress (PR0 seam + PR1 History + PR2 Summary + PR3 ContextInspector + PR4 Fork + PR5 Selection landed)**
