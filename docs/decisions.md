...
*Last updated: 2026-07-11 — ADR-042 (fork now awaits and carries over the source conversation's summary as context; input no longer pre-filled with the fork selection).*
