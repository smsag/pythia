...
*Last updated: 2026-07-17 — ADR-043 (note-chunk/suggestion relevance scoring is IDF-weighted, not flat keyword overlap — fixes a real excerpting bug on long, vocabulary-overlapping reference docs).*
