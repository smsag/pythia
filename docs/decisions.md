...
*Last updated: 2026-07-17 — ADR-046 (code-block/blockquote design-system fix: `.p-code-frame` background unified to `var(--background-secondary)`, new blockquote styling, new persistent code-type icon, copy-confirmed icon color changed from green to accent, and correction of stale `pythia-v3.html`/`design-system.css` references).*
