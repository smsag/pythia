...
| D-63 | **The settings' *Resume mode* default did nothing on its own** after ADR-231. | ADR-231 | **Closed 2026-09-26 by ADR-233** (user decision): it preselects the Resume dialog's choice, and new conversations start on full history. | — |
