...
| 2026-09-18 | D-28…D-31 added from ADR-179 (embedding off the UI thread, a resumable vault build): the live-verification the fix still needs, backend recycling, the iframe fallback's future, and why `truncation` was not taken. |
