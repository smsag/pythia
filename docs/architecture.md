...
| `services/embedding/relatedConversations.ts` | 40 | `rankRelated` — max-pairwise cosine ranking of the index vs a source conversation, min-score floor, source excluded |
