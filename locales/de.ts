...
const de: Strings = {
	...
	maxConversationsDesc:    "Maximale Anzahl gespeicherter Gespräche. Beim Erreichen des Limits werden die ältesten endgültig gelöscht — erhalten bleiben Gespräche mit Favoriten, das in einem Pythia-Panel geöffnete und jedes, auf das eine Verknüpfung zeigt. Bei 0 unbegrenzt. Ein niedrigeres Limit fragt vorher nach.",
