...
const de: Strings = {
	...
	switcherSearchPlaceholder: "Gespräche suchen",
	histMeaningGroup:          "NACH BEDEUTUNG · SCHREIBSTUBE",
	...
	instrMenu:         "Was Pythia sendet",
	instrShow:         "Zeigen, was Pythia sendet",
	instrTitle:        "Was Pythia sendet",
	instrIntro:        "Die Anweisungen, von denen jede Antwort in diesem Gespräch ausgeht. Notizen und Webergebnisse kommen pro Antwort dazu und stehen darunter.",
	instrTemplate:     "Vorlage",
	instrPending:      "Nur für die nächste Antwort gewählt: {{name}}",
	instrConversation: "Anweisungen dieses Gesprächs",
	instrConversationHint: "Beim Anlegen des Gesprächs aus seiner Vorlage übernommen. Eine später angewandte Vorlage prägt eine Antwort und ändert hier nichts.",
	instrCustom:       "Deine eigenen Anweisungen",
	instrCustomHint:   "Gelten für jedes Gespräch. Zu ändern unter Einstellungen → Beim Antworten.",
	instrHistory:      "Verlauf",
	instrHistoryFull:  "Jede frühere Nachricht wird gesendet.",
	instrFull:         "Der ganze Systemprompt",
	instrFullHint:     "So, wie die nächste Antwort ihn baut, bevor Notizen und Webergebnisse dazukommen.",
	instrCopy:         "Kopieren",
	instrNone:         "Keine",
	...
	researchOnTooltip: "Websuche: für dieses Gespräch an",
	researchNoKeyTooltip: "Websuche ist an, aber es ist kein Tavily-Schlüssel hinterlegt — sie kann nicht suchen. Unter Einstellungen → Pythia → Verbindungen hinzufügen",
	researchAutoTooltip: "Websuche: aus — sucht bei zeitkritischen Fragen und Links trotzdem von selbst (Einstellungen → Beim Antworten)",
	researchOffTooltip: "Websuche: aus",
	researchArmedTooltip: "Websuche für diese Nachricht an, wegen „{{cue}}“",
	searchAutoLabel: "{{label}} · automatisch: „{{cue}}“",
	...
	compareKept:           "{{model}} übernommen — die anderen Antworten bleiben als Tabs",
	answerTabKept:         "Die Antwort in diesem Gespräch",
