const en = {
	...
	convThemeDesc:           "Theme this conversation files its terms under. Leave empty to follow the conversation name — it then follows renames too.",
	...
	convLanguageDesc:        "Language this conversation is answered in. Default follows the plugin setting.",
