const en = {
	...
	maxConversationsDesc:    "Maximum conversations kept in storage. When the limit is reached the oldest are deleted permanently — kept are conversations with a starred passage, the one open in a Pythia panel, and any a merge link points at. Set to 0 for unlimited. Lowering this asks first.",
