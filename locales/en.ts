...
const en = {
	...
	ctxResumeSummary:  "Summary only: the {{count}} messages before you resumed are not sent",
	ctxResumeHybrid:   "Summary + recent: {{count}} older messages are not sent",
	ctxResumeChip:     "summary",
	instrMenu:         "What Pythia sends",
	instrShow:         "Show what Pythia sends",
	instrTitle:        "What Pythia sends",
	instrIntro:        "The instructions every answer in this conversation starts from. Notes and web results are added per answer and listed under it.",
	instrTemplate:     "Template",
	instrPending:      "Armed for the next answer only: {{name}}",
	instrConversation: "This conversation's instructions",
	instrConversationHint: "Set when the conversation was created, from its template. A template applied later shapes one answer and changes nothing here.",
	instrCustom:       "Your custom instructions",
	instrCustomHint:   "Added to every conversation. Change them in Settings → While answering.",
	instrHistory:      "History",
	instrHistoryFull:  "Every earlier message is sent.",
	instrFull:         "The whole system prompt",
	instrFullHint:     "As the next answer builds it, before notes and web results join it.",
	instrCopy:         "Copy",
	instrNone:         "None",
	ctxSendFullHistory:"Send full history",
	ctxFullHistoryOn:  "Full history: every message is sent again from the next answer.",
	resumedReducedNotice: "Resumed. {{count}} earlier messages are left out; the summary stands in for them. Open Context above the chat to send the full history.",
	...
	researchOnTooltip: "Web search: on for this conversation",
	researchNoKeyTooltip: "Web search is on, but no Tavily key is set — it cannot search. Add one under Settings → Pythia → Connections",
	researchAutoTooltip: "Web search: off — still searches by itself for time-sensitive questions and links (Settings → While answering)",
	researchOffTooltip: "Web search: off",
	researchArmedTooltip: "Web search on for this message, because of “{{cue}}”",
	searchAutoLabel: "{{label}} · automatic: “{{cue}}”",
	...
	compareKept:           "Kept {{model}} — the other answers stay as tabs",
	answerTabKept:         "The answer in this conversation",
	...
	webSearchKeyRejected: "Tavily rejected the web search key. Check it under Settings → Pythia → Connections.",
	webSearchQuotaReached: "Your Tavily account has used up its credits, so web search stopped. Raise the limit at tavily.com or wait for the next month.",
