...
const settingsEn = {
	...
	webSearchAutoArmName:    "Auto-search on time-sensitive questions and links",
	webSearchAutoArmDesc:    "When research mode is off, allow a web search for a single message if it looks time-sensitive (latest, current, prices, news, a recent year…) or contains a link. Note links like [[2026-09-26]] do not count. Requires a Tavily key. The globe pulses when this fires.",
