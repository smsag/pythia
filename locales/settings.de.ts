...
const settingsDe = {
	...
	webSearchAutoArmName:    "Automatische Suche bei aktuellen Fragen und Links",
	webSearchAutoArmDesc:    "Wenn der Recherchemodus aus ist, wird für eine einzelne Nachricht eine Websuche erlaubt, sofern sie zeitkritisch wirkt (neueste, aktuell, Preise, Nachrichten, ein aktuelles Jahr …) oder einen Link enthält. Notiz-Links wie [[2026-09-26]] zählen nicht. Erfordert einen Tavily-Schlüssel. Der Globus pulsiert, wenn dies auslöst.",
