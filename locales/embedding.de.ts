...
const embeddingDe: typeof embeddingEn = {
	...
	embeddingModelDesktopNote: "Smartphones und Tablets nutzen stattdessen {{model}} – {{chosen}} braucht mehr Speicher, als sie erlauben.",
	embeddingModelLatinNote: "Es liefert für jede in lateinischer Schrift geschriebene Sprache (Deutsch, Englisch, Italienisch, Spanisch, Französisch, …) dieselben Ergebnisse wie Mehrsprachig und teilt den Index des Desktops; Notizen in kyrillischer, griechischer oder asiatischer Schrift treffen auf dem Smartphone nur grob.",
	...
	vaultIndexStateLoading:      "Modell wird geladen… Beim ersten Mal wird es heruntergeladen (≈ {{mb}} MB), das kann auf dem Smartphone eine Minute dauern.",
	...
	vaultIndexStateOutdated:     "Veraltet – Ordner oder Notizlimit haben sich seit dem Aufbau geändert. Der nächste Aufbau fügt neue Notizen hinzu und entfernt die, die nicht mehr dazugehören; bereits indexierte Notizen bleiben erhalten und werden nicht neu eingebettet. Er läuft, sobald er gebraucht wird, oder tippe auf „Jetzt aufbauen“.",
	vaultIndexStateFailed:       "Der letzte Aufbau ist fehlgeschlagen: {{error}}",
	vaultIndexStateOutOfMemory:  "Abgebrochen – diesem Gerät ist beim Laden des Modells der Speicher ausgegangen. Das passiert meist, nachdem Pythia in der laufenden App aktualisiert oder neu geladen wurde – iOS gibt dabei den Speicher des alten Modells nicht frei. Schließe Obsidian ganz (wegwischen), öffne es neu und tippe dann auf „Jetzt aufbauen“.",
	vaultIndexStatePaused:       "Pausiert – die letzten {{count}} Aufbauten sind nicht fertig geworden. Das passiert, wenn die App mittendrin geschlossen wird oder dem Gerät der Speicher ausgeht, deshalb lädt Pythia das Modell nicht von selbst – der Vault-Kontext bleibt aus, bis du auf „Jetzt aufbauen“ tippst. Bereits Indexiertes bleibt erhalten.",
