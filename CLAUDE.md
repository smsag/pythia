...
/
  ...
  services/
    ...
    glossary.ts               ← pure: parseGlossary, upsertGlossaryEntry, buildTermMatcher (ADR-136)
  ...
  tests/                      ← Vitest unit tests (npm test) — 723 tests across 48 files
  locales/
...
- Every occurrence is marked in every conversation, via `repaintTerms` and a single alternation from `buildTermMatcher`
