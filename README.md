...
- **Cost per answer** — every answer's label shows the token counts and an estimated price (`↑1.628 ↓941 · ≈ $0.012`), priced from a date-stamped list-price table; the conversation panel shows a running total per conversation. Switch it off under *Show cost per answer* in settings
