...
export class OpenAIProvider extends BaseProvider {
	...
	protected async prepareStream(
		...
		this.openaiTools = onToolCall
			? getToolDefinitions(conversation.outputFolder ?? this.settings.scratchFolder, conversation.writeMode, conversation.researchMode ?? false, conversation.upvotyMode ?? false).map((def) => ({
